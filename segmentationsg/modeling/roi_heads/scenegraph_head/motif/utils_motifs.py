...
def obj_edge_vectors(names, wv_dir, wv_type='glove.6B', wv_dim=300):
    ...
    token_mappings = {'contentblock': 'paragraph', 'bibblock': 'bibliography', 'figurecaption': 'caption',
                      'figuregraphic': 'graphic', 'pagenr': 'numbering', 'tablecaption': 'caption',
                      'subject': 'keywords', 'head': 'header', 'foot': 'footer',
                      'backmatter': 'frontpage', 'bookreview': 'article', 'documentroot': 'root',
                      'equationformula': 'formula',
                      'equationlabel': 'label', 'frontmatter': 'frontpage', 'itemcol': 'column', 'postface': 'preface',
                      'referencelist': 'references', 'tablecell': 'cell', 'tablecol': 'column',
                      'tablefootnote': 'footnote',
                      'tableofcontent':'toc', 'tablerow': 'row',
                      'backgroundfigure':'watermark',
                      'orderedgroup': 'ordered',
                      'unorderedgroup': 'unordered',
                      '__background__': 'background'
                      }

    for i, token in enumerate(names):
        if token in token_mappings:
            print('mapping {} to {} for word embeddings'.format(token, token_mappings[token]))
